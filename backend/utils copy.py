...
def get_top_similar_jobs(employee_vector: List[float], job_vectors: Dict[int, List[float]], top_n: int = TOP_N_JOBS) -> List[int]:
    """
    最も類似度の高い求人IDを取得する
    ...
    return [job_ids[i] for i in top_indices]
